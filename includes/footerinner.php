    ...
    <!-- row -->
         ...
         <div class="col-lg-4 text-center">
           <!-- logo -->
            ...
            <li><i class="fas fa-map-marker margin-icon"></i> 16/A, S.C.Nagar, Varatharajapuram, Coimbatore-641015.</li>
               ...
               <li class="list-inline-item"><a title="Facebook" href="https://www.facebook.com/Brainseedpreschool/"><i class="fab fa-facebook-f"></i></a></li>
         ...
         <div class="col-lg-4 text-center res-margin">
            ...
            <ul class="list-unstyled mt-3">
               <li class="mb-1"><i class="fas fa-phone margin-icon "></i> +91 9626555527, +91 9751122440</li>
                ...
                <li class="mb-1"><i class="fas fa-envelope margin-icon"></i> <a href="mailto:happychild@whiteminds.in"> happychild@whiteminds.in</a></li>

               <p style="margin-bottom: 0px;"><b>For Career Opportunities: </b></p>
               <li class="mb-1"><i class="fas fa-envelope margin-icon"></i> <a href="mailto:goodwork@whiteminds.in">goodwork@whiteminds.in</a></li>
      ...
      <div class="row">
         <div class="credits col-sm-12">
            <p>Copyright 2021 White Minds. All Rights Reserved.</p>
         </div>
      </div>
      <!--/row-->
   </div>
